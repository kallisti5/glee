...
int main()
{

  {
    ...
    std::string pat6    = "(?i)[^x]";
    std::string str6[]  = { "X", "x" };
    bool        exp6[]  = { false, false };
    int         num6    = 2;

    std::string   pats[] = { pat0, pat1, pat2, pat3, pat4, pat5, pat6 };
    std::string * strs[] = { str0, str1, str2, str3, str4, str5, str6 };
    bool        * exps[] = { exp0, exp1, exp2, exp3, exp4, exp5, exp6 };
    int           nums[] = { num0, num1, num2, num3, num4, num5, num6 };
